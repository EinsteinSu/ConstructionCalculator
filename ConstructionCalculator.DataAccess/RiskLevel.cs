...
namespace ConstructionCalculator.DataAccess
{
    ...
    {
        [Display(Name = "最小值")] public double MinValue { get; set; }

        [Display(Name = "最大值")] public double MaxValue { get; set; }

        [Display(Name = "颜色")] [MaxLength(20)] public string Color { get; set; }

        [Display(Name = "说明")] public string Description { get; set; }
